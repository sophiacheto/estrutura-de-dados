...
public class TestMax {
   ...
   static int maxRec1(int v[], int start, int end) {
      ...
      int a = maxRec1(v, start+1, end); // chamada recursiva (resto da lista)
      return Math.max(v[start], a);     // combinar resultado
   }
   ...
   static int sumRec2(int v[], int start, int end) {
        ...
        int somaEsq = sumRec2(v, start, meio);
        int somaDir = sumRec2(v, meio+1, end);
   ...
   public static void main(String[] args) {
      ...
      System.out.println(sumRec1(v, 0, v.length-1));
      System.out.println(sumRec2(v, 0, v.length-1));
   }
